...
def initialize_datadir(dirname, n):
    ...
    with open(os.path.join(datadir, "navcoin.conf"), 'w', encoding='utf8') as f:
        f.write("devnet=1\n")
        f.write("staking=0\n")
...
def get_auth_cookie(datadir):
    ...
    if os.path.isfile(os.path.join(datadir, "devnet", ".cookie")):
        with open(os.path.join(datadir, "devnet", ".cookie"), 'r') as f:
            userpass = f.read()
...
def delete_cookie_file(datadir):
    if os.path.isfile(os.path.join(datadir, "devnet", ".cookie")):
        ...
        os.remove(os.path.join(datadir, "devnet", ".cookie"))
