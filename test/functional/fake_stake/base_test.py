...
'''
class PIVX_FakeStakeTest(NavCoinTestFramework):
    ...
    def get_prevouts(self, utxo_list, blockHeight):
        ...
        :param   utxo_list:                 (JSON list) utxos returned from listunspent used as input
    ...
    def log_data_dir_size(self):
        ''' Prints the size of the '/devnet/blocks' directory.
        :param:
        :return:
        '''
        init_size = dir_size(self.node.datadir + "/devnet/blocks")
