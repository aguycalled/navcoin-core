...
BASE_SCRIPTS= [
    ...
    'cfund_donate.py',
    'cfund_listproposals.py',
    'cfund_paymentrequest-duplicate.py',
    'cfund_paymentrequest-extract-funds.py',
    'cfund_paymentrequest-hardfork-452.py',
    'cfund_paymentrequest-payout.py',
    'cfund_paymentrequest-state-accept-expired-proposal.py',
    'cfund_paymentrequest-state-accept.py',
    'cfund_paymentrequest-state-expired.py',
    'cfund_paymentrequest-state-reorg.py',
    'cfund_paymentrequestvotelist.py',
    'cfund_proposal-state-accept.py',
    'cfund_proposal-state-expired.py',
    'cfund_proposalvotelist.py',
    'cfund_rawtx-create-proposal.py',
    'cfund_rawtx-paymentrequest-create.py',
    'cfund_rawtx-paymentrequest-vote.py',
    'cfund_rawtx-proposal-vote.py',
    'cfund_vote.py',
    'coldstaking_spending.py',
    'coldstaking_staking.py',
    'rpc_pos_getcoldstakingaddress.py',
    'rpc_pos_getstakereport.py',
    'rpc_pos_getstakinginfo.py',
    'feature_hardfork-451.py',
    'feature_hardfork-452.py',
    'feature_mnemonic.py',
    'p2p_nothingatstake.py',
    'feature_reject-version-bit.py',
    'p2p_stakeimmaturebalance.py',
    'p2p_stakingaddress.py',
    'feature_staticr-staking-amount.py',
    'feature_staticr-tx-send.py',
]
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, runs_ci):
    ...
    # Warn if navcoind is already running (unix only)
    try:
        if subprocess.check_output(["pidof", "navcoind"]) is not None:
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("(example|feature|interface|mempool|mining|p2p|rpc|wallet|cfund|coldstaking)_")
