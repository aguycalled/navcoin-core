...
CommunityFundSuccessDialog::CommunityFundSuccessDialog(uint256 hash, QWidget *parent, CGovernance::CProposal* proposal) :
    QDialog(parent),
...
CommunityFundSuccessDialog::CommunityFundSuccessDialog(uint256 hash, QWidget *parent, CGovernance::CPaymentRequest* prequest) :
    QDialog(parent),
    ui(new Ui::CommunityFundSuccessDialog),
    proposal(0),
    prequest(prequest)
