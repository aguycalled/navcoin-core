...
SendCommunityFundDialog::SendCommunityFundDialog(QWidget *parent, CGovernance::CProposal* proposal, int secDelay) :
    QDialog(parent),
...
SendCommunityFundDialog::SendCommunityFundDialog(QWidget *parent, CGovernance::CPaymentRequest* prequest, int secDelay) :
    QDialog(parent),
    ui(new Ui::SendCommunityFundDialog),
    proposal(0),
    prequest(prequest),
